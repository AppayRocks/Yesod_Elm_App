...
var _user$project$Login$viewFormErrors = F2(
...
var _user$project$Login$viewHeader = function (version) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Elm Login Form: ', version)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Examples of Form built in elm'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Login$viewFooter = function (version) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('https://google.co.in'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('https://github.com/AppayRocks/Yesod_Elm_App'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Login$viewSimple = F2(
	function (exampleVersion, viewForm) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Login$viewHeader(exampleVersion),
				_1: {
					ctor: '::',
					_0: viewForm,
					_1: {
						ctor: '::',
						_0: _user$project$Login$viewFooter(exampleVersion),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$Login_ops = _user$project$Login_ops || {};
_user$project$Login_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Login$postRequest = function (model) {
...
var _user$project$Login$initialModel = {
	errors: {ctor: '[]'},
	email: '',
	password: '',
...
var _user$project$Login$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _user$project$Login$SubmitForm = {ctor: 'SubmitForm'};
var _user$project$Login$NoOp = {ctor: 'NoOp'};
var _user$project$Login$Password = {ctor: 'Password'};
var _user$project$Login$Email = {ctor: 'Email'};
var _user$project$Login$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
			...
			A2(_user$project$Login_ops['=>'], _user$project$Login$Email, 'email can\'t be blank.')),
		_1: {
			ctor: '::',
			_0: A2(
				_rtfeldman$elm_validate$Validate$ifBlank,
				...
				A2(_user$project$Login_ops['=>'], _user$project$Login$Password, 'password can\'t be blank.')),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Login$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'SubmitForm':
				var _p5 = A2(_rtfeldman$elm_validate$Validate$validate, _user$project$Login$modelValidator, model);
				if (_p5.ctor === '[]') {
					return {
						ctor: '_Tuple2',
						...
						_1: A2(
							...
							_user$project$Login$postRequest(model))
					};
				} else {
					return {
						ctor: '_Tuple2',
				...
				if (_p4._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								response: _elm_lang$core$Maybe$Just(_p4._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$Login$viewForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Login$SubmitForm),
			_1: {
				ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Login$SetEmail),
										_1: {
											ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$Login$viewFormErrors, _user$project$Login$Email, model.errors),
							_1: {ctor: '[]'}
						}
					}
				}),
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Login$viewFormErrors, _user$project$Login$Password, model.errors),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Login$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				_user$project$Login$viewSimple,
				'v01',
				_user$project$Login$viewForm(model)),
			_1: {ctor: '[]'}
		});
};
